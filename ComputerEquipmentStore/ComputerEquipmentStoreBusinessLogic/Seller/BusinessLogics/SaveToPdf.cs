...
namespace ComputerEquipmentStoreBusinessLogic.Seller.BusinessLogics
{
    public class SaveToPdf
    {
        public static void CreateDoc(PdfInfoStorekeeper info)
        {
            ...
            foreach (var componentProductAssembly in info.ComponentProductAssembly)
            {
                CreateRow(new PdfRowParameters
                {
                    Table = table,
                    Texts = new List<string> {
                                componentProductAssembly.Component,
                                componentProductAssembly.DataSale.ToShortDateString(),
                                componentProductAssembly.AssemblyProduct
                            },
                    Style = "Normal",
