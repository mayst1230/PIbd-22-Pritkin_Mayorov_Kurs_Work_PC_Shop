        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Assemblies_Buyers_BuyerId",
                        column: x => x.BuyerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Components_Sellers_SellerId",
                        column: x => x.SellerId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Comments_Assemblies_AssemblyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseAssemblies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PurchaseAssemblies_Assemblies_AssemblyId",
                        column: x => x.AssemblyId,
                        principalTable: "Assemblies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PurchaseAssemblies_AssemblyId",
                table: "PurchaseAssemblies",
                column: "AssemblyId");

            migrationBuilder.CreateIndex(
                name: "IX_PurchaseAssemblies_PurchaseId",
                table: "PurchaseAssemblies",
                column: "PurchaseId");
